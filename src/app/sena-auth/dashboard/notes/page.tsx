...
import { deleteNoteAction } from '@/actions/content';
  ...
  return (
    <div className="space-y-12">
      <div className="flex justify-between items-end border-b cosmic-border pb-4">
        <div>
          <h2 className="text-3xl font-serif tracking-widest mb-1 text-[var(--foreground)]">管理者手記管理 (LOGS)</h2>
          <p className="text-xs font-mono text-[var(--muted-foreground)] tracking-widest uppercase italic">Manage File-Based Monologues // SRC/CONTENT/NOTES/*.MD</p>
        </div>
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="border-b-2 border-[var(--foreground)]">
              ...
              <th className="py-4 px-4 font-mono text-[10px] tracking-widest uppercase text-[#5a5248]">Slug / Filename</th>
